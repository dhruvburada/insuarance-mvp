    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          disabled={disabled}
          className={cn(
            "h-10 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm flex items-center justify-start text-left font-normal hover:bg-slate-50 transition-all outline-none focus:outline-none focus-visible:outline-none focus:border-lime-500 focus-visible:border-lime-500 focus:ring-1 focus:ring-lime-500 disabled:cursor-not-allowed disabled:opacity-50",
